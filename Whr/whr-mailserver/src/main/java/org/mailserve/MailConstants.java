...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "org.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "org.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "org.mail.routing.key";
