...
public class POUItils {
    public static ResponseEntity<byte[]> employee2Excel(List<Employee> list) {
        ...
        //文档管理员
        documentSummaryInformation.setManager("vhr");
        //设置公司信息
        documentSummaryInformation.setCompany("www.123.vhr");
        //4.获取文档摘要
        SummaryInformation summaryInformation = workbook.getSummaryInformation();
        //文档标题
        summaryInformation.setTitle("员工信息表");
        //文档作者
        summaryInformation.setAuthor("shy");
        // 文档备注
        summaryInformation.setComments("本文由某人编写");
        //5.创建样式
        //创建标题行的样式
